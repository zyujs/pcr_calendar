...
def transform_calendar_data(data):
    ...
    for i in range(len(data)):
        for day_str in data[i]['day']:
            ...
            day = int(day_str)
            for event_name in data[i]['day'][day_str]:
            ...
            for event_name in list(event_cache.keys()):
                if event_name in data[i]['day'][day_str]:
                    ...
                    event_list.append({
                        ...
                        'end': f'{event_cache[event_name]["end_year"]}/{event_cache[event_name]["end_month"]}/{event_cache[event_name]["end_day"]} 04:59',
                    })
